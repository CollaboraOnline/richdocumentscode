OC.L10N.register(
    ...
    "Administration settings > Nextcloud Office" : "Administrationsindstillinger > Nextcloud Office",
    "The Built-in CODE Server is designed to work with the Nextcloud Office app." : "Den indbyggede CODE-server er designet til at fungere med Nextcloud Office-appen.",
    "Install it from the Nextcloud App Store." : "Instaler den fra Nextcloud App Store.",
    "An error occurred while trying to check your Collabora Online app installation. You may report this error\n                with the tag: <em>richdocuments-EnabledCheckFailed</em>" : "Der opstod en fejl under forsøg på at kontrollere din Collabora Online app installation. Du kan rapportere denne fejl\n                med følgende tag: <em>richdocuments-EnabledCheckFailed</em>"
},
