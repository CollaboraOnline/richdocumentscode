OC.L10N.register(
    ...
    "This app has to be installed and used together with the **[Collabora Online](https://apps.nextcloud.com/apps/richdocuments)** app.\n\nCollabora Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers.\n\nThis app provides a built-in server with all of the document editing features of Collabora Online. Easy to install, for personal use or for small teams. A bit slower than a standalone server and without the advanced scalability features." : "Tuto aplikaci je třeba nainstalovat a používat ve spojení s  aplikací **[Collabora Online](https://apps.nextcloud.com/apps/richdocuments)**.\n\nCollabora Online je online sada kancelářských aplikací, založená na LibreOffice pro upravování dokumentů ve více lidech naráz. Podporuje všechny hlavní souborové formáty dokumentů, tabulek a prezentací a funguje ve všech moderních webových prohlížečích.\n\nTato aplikace poskytuje vestavěný server, se všemi funkcemi pro úpravu dokumentů jako Collabora Online. Snadno se instaluje a je určené pro osobní použití nebo pro malé týmy. Je o něco pomalejší než samostatný server než samostatný server a neobsahuje pokročilé funkce pro škálování výkonu.",
    ...
    "install the correct version from the Nextcloud App Store." : "nainstalujte správnou verzi z katalogu Nextcloud aplikací.",
