OC.L10N.register(
    ...
    "This app has to be installed and used together with the **[Collabora Online](https://apps.nextcloud.com/apps/richdocuments)** app.\n\nCollabora Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers.\n\nThis app provides a built-in server with all of the document editing features of Collabora Online. Easy to install, for personal use or for small teams. A bit slower than a standalone server and without the advanced scalability features." : "Aplikacja musi być zainstalowana i używana razem z aplikacją **[Collabora Online](https://apps.nextcloud.com/apps/richdocuments)**.\n\nCollabora Online to potężny pakiet biurowy online oparty na LibreOffice z funkcją edycji grupowej, który obsługuje wszystkie główne formaty dokumentów, arkusze kalkulacyjne i pliki prezentacji oraz współpracuje ze wszystkimi nowoczesnymi przeglądarkami.\n\nAplikacja zapewnia wbudowany serwer ze wszystkimi funkcjami edycji dokumentów Collabora Online. Łatwy w instalacji, do użytku osobistego lub dla małych zespołów. Nieco wolniejszy niż samodzielny serwer oraz bez zaawansowanych funkcji skalowalności.",
