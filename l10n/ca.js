OC.L10N.register(
    ...
    "This app has to be installed and used together with the **[Collabora Online](https://apps.nextcloud.com/apps/richdocuments)** app.\n\nCollabora Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers.\n\nThis app provides a built-in server with all of the document editing features of Collabora Online. Easy to install, for personal use or for small teams. A bit slower than a standalone server and without the advanced scalability features." : "Aquesta aplicació s'ha d'instal·lar i utilitzar juntament amb l'aplicació **[Collabora Online](https://apps.nextcloud.com/apps/richdocuments)** app.\n\nCollabora Online és una potent suite d'oficina en línia basada en LibreOffice amb edició col·laborativa, que admet tots els tipus documents principals, full de càlcul i formats de fitxer de presentació i funciona juntament amb tots els navegadors moderns.\n\nAquesta aplicació proporciona un servidor integrat amb totes les característiques d'edició de documents de Collabora Online. Fàcil d'instal·lar, per a ús personal o per a equips reduïts. Una mica més lent que un servidor independent i sense les característiques avançades d'escalabilitat.",
